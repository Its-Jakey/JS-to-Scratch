...
let g_ram_size = 0;
let g_dma_mdec_in_irq_delay = 0;
let g_dma_mdec_out_irq_delay = 0;
let g_dma_cdrom_irq_delay = 0;
let g_dma_spu_irq_delay = 0;
let g_dma_gpu_irq_delay = 0;
let g_dma_otc_irq_delay = 0;
let g_dma_dpcr = 0;
let g_dma_dicr = 0;
let cpu_opcode = 0;
let cpu_pc = 0;
...
let cpu_load_d = 0;
let cpu_load_v = 0;
let cpu_last_cycles = 0;
let cpu_total_cycles = 0;
let cpu_branch = 0;
let cpu_delay_slot = 0;
let cpu_branch_taken = 0;
let cpu_cop2_dr_otz = 0;
let cpu_cop2_dr_ir0 = 0;
let cpu_cop2_dr_ir1 = 0;
let cpu_cop2_dr_ir2 = 0;
let cpu_cop2_dr_ir3 = 0;
let cpu_cop2_dr_sz0 = 0;
let cpu_cop2_dr_sz1 = 0;
let cpu_cop2_dr_sz2 = 0;
let cpu_cop2_dr_sz3 = 0;
let cpu_cop2_dr_rgb0_u32 = 0;
let cpu_cop2_dr_rgb1_u32 = 0;
let cpu_cop2_dr_rgb2_u32 = 0;
let cpu_cop2_dr_rgbc_u32 = 0;
let cpu_cop2_dr_res1 = 0;
let cpu_cop2_dr_mac0 = 0;
let cpu_cop2_dr_mac1 = 0;
let cpu_cop2_dr_mac2 = 0;
let cpu_cop2_dr_mac3 = 0;
let cpu_cop2_dr_irgb = 0;
let cpu_cop2_dr_lzcs = 0;
let cpu_cop2_dr_lzcr = 0;
let cpu_cop2_cr_rt_33 = 0;
let cpu_cop2_cr_tr_x = 0;
let cpu_cop2_cr_tr_y = 0;
let cpu_cop2_cr_tr_z = 0;
let cpu_cop2_cr_l_33 = 0;
let cpu_cop2_cr_bk_x = 0;
let cpu_cop2_cr_bk_y = 0;
let cpu_cop2_cr_bk_z = 0;
let cpu_cop2_cr_lr_33 = 0;
let cpu_cop2_cr_fc_x = 0;
let cpu_cop2_cr_fc_y = 0;
let cpu_cop2_cr_fc_z = 0;
let cpu_cop2_cr_ofx = 0;
let cpu_cop2_cr_ofy = 0;
let cpu_cop2_cr_h = 0;
let cpu_cop2_cr_dqa = 0;
let cpu_cop2_cr_dqb = 0;
let cpu_cop2_cr_zsf3 = 0;
let cpu_cop2_cr_zsf4 = 0;
let cpu_cop2_cr_flag = 0;
let cpu_gte_lm = 0;
let cpu_gte_sf = 0;
let cpu_gte_mx = 0;
let cpu_gte_v = 0;
...
let cpu_s_mac0 = 0;
let cpu_s_mac3 = 0;
let gte_mvmva_mx_11 = 0;
let gte_mvmva_mx_12 = 0;
let gte_mvmva_mx_13 = 0;
let gte_mvmva_mx_21 = 0;
let gte_mvmva_mx_22 = 0;
let gte_mvmva_mx_23 = 0;
let gte_mvmva_mx_31 = 0;
let gte_mvmva_mx_32 = 0;
let gte_mvmva_mx_33 = 0;
let gte_mvmva_vx = 0;
let gte_mvmva_vy = 0;
let gte_mvmva_vz = 0;
let gte_mvmva_cv_x = 0;
let gte_mvmva_cv_y = 0;
let gte_mvmva_cv_z = 0;
let timer_hblank = 0;
let timer_vblank = 0;
let cdrom_disc_track_start = 0;
let cdrom_disc_track_end = 0;
let cdrom_disc_open = 0;
let cdrom_disc_type = 0;
let cdrom_index = 0;
let cdrom_pending_speed_switch_delay = 0;
let cdrom_ier = 0;
let cdrom_ifr = 0;
let cdrom_mode = 0;
let cdrom_data_req = 0;
let cdrom_data_rd = 0;
let cdrom_data_wr = 0;
let cdrom_resp_rd = 0;
let cdrom_resp_wr = 0;
let cdrom_param_rd = 0;
let cdrom_param_wr = 0;
let cdrom_pending_command = 0;
let cdrom_busy = 0;
let cdrom_xa_lba = 0;
let cdrom_xa_playing = 0;
let cdrom_xa_mute = 0;
let cdrom_xa_channel = 0;
let cdrom_xa_file = 0;
let cdrom_xa_remaining_samples = 0;
let cdrom_state = 0;
let cdrom_prev_state = 0;
let cdrom_delay = 0;
let cdrom_pending_lba = 0;
let cdrom_lba = 0;
let cdrom_read_ongoing = 0;
let pad_buttons = 0;
let pad_rxq_len = 0;
let pad_rxq_pos = 0;
let pad_dest = 0;
let pad_cycles_until_irq = 0;
let pad_irq_bit = 0;
let pad_mode = 0;
let pad_ctrl = 0;
let pad_baud = 0;
let pad_stat = 0;
let g_bus_access_cycles = 0;
let mc2_ram_size = 0;
let mc3_cache_control = 0;
let ic_stat = 0;
let ic_mask = 0;
let gpu_display_off_init = 0;
let gpu_recv_data = 0;
let gpu_buf_index = 0;
let gpu_cmd_args_remaining = 0;
let gpu_draw_attrib = 0;
let gpu_draw_clut = 0;
let gpu_draw_texp = 0;
let gpu_rect_x = 0;
let gpu_rect_y = 0;
...
let gpu_c0_ysiz = 0;
let gpu_c0_tsiz = 0;
let gpu_gp1_10h_req = 0;
let gpu_state = 0;
let gpu_display_mode = 0;
let gpu_gpustat = 0;
let gpu_draw_x1 = 0;
let gpu_draw_y1 = 0;
let gpu_draw_x2 = 0;
...
let gpu_line = 0;
let gpu_dbg_vb = 0;
let gpu_dbg_tex_count = 0;
let gpu_dbg_tex_ymin = 0;
let mdec_io_base = 0;
let mdec_io_size = 0;
let mdec_cmd = 0;
let mdec_input_index = 0;
let mdec_input_size = 0;
let mdec_output_index = 0;
let mdec_output_words_remaining = 0;
let mdec_words_remaining = 0;
let mdec_current_block = 0;
let mdec_output_bit15 = 0;
let mdec_output_signed = 0;
let mdec_output_depth = 0;
let mdec_input_request = 0;
let mdec_output_request = 0;
let mdec_busy = 0;
let mdec_input_full = 0;
let mdec_output_empty = 0;
let mdec_enable_dma0 = 0;
let mdec_enable_dma1 = 0;
let mdec_recv_color = 0;
let mdec_cmd_decode_count = 0;
let mdecSrcIndex = 0;
let mdecBlkId = 0;
let mdecQuantId = 0;
let sio_ctrl = 0;
...
function bus_ic(write, offset, value, width) {
  ...
  g_bus_access_cycles = 0;
  if (write) {
    const reg = write_value_as_32(value, offset, width);
    switch (offset & ~3) {
      case 0x00:
        ic_stat &= reg;
        break;
...
function psx_cpu_execute() {
  if (0) return;
  const primary = (OP() & 0xfc000000) >>> 26;
  ...
  switch (primary) {
    case 0x00: {
      ...
      switch (funct) {
        ...
        case 0x1a: {
          const su = s32(cpu_r[rs()]);
          const tu = s32(cpu_r[rt()]);
          if (!tu) {
            cpu_hi = u32(su);
        ...
        case 0x21:
          ...
          return 2;
        case 0x22: {
          const a = s32(cpu_r[rs()]);
          const b = s32(cpu_r[rt()]);
          r = a - b;
          const ou = ((a ^ b) & (a ^ r)) >>> 31;
    ...
    case 0x01: {
      cpu_branch = 1;
      cpu_branch_taken = 0;
      const rtField = (OP() & 0x001f0000) >>> 16;
      switch (rtField) {
        case 0x0000: {
          DO_PENDING_LOAD();
    ...
    case 0x22: {
      ...
      const load = bus_access(0, addr & 0xfffffffc, 0, 32);
    ...
    case 0x2a: {
      ...
      let v = bus_access(0, aligned, 0, 32);
      switch (addr & 3) {
        case 0:
...
const MAC0_MIN = -2147483648;
const MAC0_MAX = 2147483647;
const MAC_MIN = -8796093022208;
const MAC_MAX = 8796093022207;
...
function gte_handle_lzcs_write() {
  ...
  const b = (u32(cpu_cop2_dr_lzcs) >>> 31) & 1;
...
function gte_clamp_ir_z(value, sf, lm) {
  if (0) return;
  const value_sf = (s64_sar(value, sf));
  const value_12 = (s64_sar(value, 12));
  let min = 0;
...
function gte_divide(n, d) {
  ...
  const shift = clz32(d) - 16;

  const r1 = (d << shift) & 0x7fff;
  const r2 = PSX_GTE_UNR_TABLE[(r1 + 0x40) >> 7] + 0x101;
...
function gte_rtp(i, dq) {
  if (0) return;
  const vx = (s16(cpu_cop2_dr_v_xy[i]));
  const vy = (s16(cpu_cop2_dr_v_xy[i] >>> 16));
  const vz = (cpu_cop2_dr_v_z[i]);
  ...
  const div = gte_divide(cpu_cop2_cr_h, cpu_cop2_dr_sz3);
  cpu_cop2_dr_sxy_xy[0] = cpu_cop2_dr_sxy_xy[1];
  cpu_cop2_dr_sxy_xy[1] = cpu_cop2_dr_sxy_xy[2];
  gte_sxy_set_x(
    2,
...
function psx_gte_i_ncds() {
  ...
  const vx = (s16(cpu_cop2_dr_v_xy[0]));
  const vy = (s16(cpu_cop2_dr_v_xy[0] >>> 16));
  const vz = (cpu_cop2_dr_v_z[0]);
...
function psx_gte_i_avsz3() {
  ...
  const avg = (cpu_cop2_cr_zsf3 * (cpu_cop2_dr_sz1 + cpu_cop2_dr_sz2 + cpu_cop2_dr_sz3));
...
function gte_read_register(r) {
  ...
  const cat = gte_rd_cat[r];
  const sub = gte_rd_sub[r];
...
function gte_write_register(r, value) {
  ...
  const cat = gte_wr_cat[r];
  const sub = gte_wr_sub[r];
...
function timer_read_mode(i) {
  if (0) return;
  const value = u16(timer_mode[i] & 0x1fff);
...
function timer_blank_sync(i, start) {
  ...
  const sync_mode = (timer_mode[i] >>> 1) & 3;
...
function gpu_modulate_texel(texel, mod) {
  if (0) return;
  const tr = ((texel >>> 0) & 0x1f) << 3;
  const tg = ((texel >>> 5) & 0x1f) << 3;
  const tb = ((texel >>> 10) & 0x1f) << 3;
...
function gpu_blend_transp(color, back) {
  if (0) return;
  const cr = ((color >>> 0) & 0x1f) << 3;
  const cg = ((color >>> 5) & 0x1f) << 3;
  const cb = ((color >>> 10) & 0x1f) << 3;
  const br = ((back >>> 0) & 0x1f) << 3;
  const bg = ((back >>> 5) & 0x1f) << 3;
  const bb = ((back >>> 10) & 0x1f) << 3;
...
function gpu_fetch_texel(tx, ty, tpx, tpy, clutx, cluty, depth) {
  ...
  if (depth === 0) {
    const texel = vram[tpx + (tx >>> 2) + (tpy + ty) * 1024];
    const index = (texel >>> ((tx & 0x3) << 2)) & 0xf;
...
const GPU_POLY_ARGS = [3, 6, 4, 8, 5, 8, 7, 11];
const GPU_POLY_COLOR_OFF = [0, 0, 2, 3];
const GPU_POLY_VERT_OFF = [1, 2, 2, 3];
const GPU_POLY_TEXC_OFF = [0, 2, 0, 3];
const GPU_POLY_TEXP_OFF = [0, 4, 0, 6];
...
function gpu_rect() {
  if (0) return;
  if (gpu_state === 0) {
    const size = (gpu_buf[0] >>> 27) & 3;
    const textured = (gpu_buf[0] & 0x04000000) !== 0;
  ...
  if (gpu_state === 1) {
    if (!gpu_cmd_args_remaining) {
      ...
      const raw = (gpu_draw_attrib & 1) !== 0;

      const size_offset = 2 + (textured ? 1 : 0);
...
function gpu_poly() {
  ...
  if (gpu_state === 1) {
    if (!gpu_cmd_args_remaining) {
      ...
      const color_offset = GPU_POLY_COLOR_OFF[layout];
      const vert_offset = GPU_POLY_VERT_OFF[layout];
      const texc_offset = GPU_POLY_TEXC_OFF[layout];
      const texp_offset = GPU_POLY_TEXP_OFF[layout];
...
function gpu_draw_line() {
  if (0) return;
  if (gpu_state === 0) {
    const shaded = (gpu_buf[0] & 0x10000000) !== 0;
    const polyline = (gpu_buf[0] & 0x08000000) !== 0;
  ...
  if (gpu_state === 1) {
    if (gpu_buf[0] & 0x08000000) {
      ...
      const end = gpu_buf[0] & 0x10000000 ? 3 : 2;
      const lx0 = gpu_buf[1] & 0xffff;
      const ly0 = gpu_buf[1] >>> 16;
      const lx1 = gpu_buf[end] & 0xffff;
      const ly1 = gpu_buf[end] >>> 16;
      const rgb = gpu_buf[0] & 0xffffff;
...
function gpu_xfer_load_pixel() {
  if (0) return;
  let xpos = (gpu_xpos + gpu_xcnt) & 0x3ff;
  let ypos = (gpu_ypos + gpu_ycnt) & 0x1ff;
...
function gpu_cmd_xfer() {
  ...
  switch (gpu_state) {
    ...
    case 1:
      ...
      switch (op) {
        case 0x02: {
          const x0 = (gpu_buf[1] & 0xffff) & 0x3f0;
          const y0 = (gpu_buf[1] >>> 16) & 0x1ff;
          const w = ((gpu_buf[2] & 0x3ff) + 0x0f) & 0xfffffff0;
          const h = (gpu_buf[2] >>> 16) & 0x1ff;
          const rgb = gpu_buf[0] & 0xffffff;
          const color =
            ((rgb & 0x0000f8) >>> 3) |
            ((rgb & 0x00f800) >>> 6) |
        ...
        case 0x80: {
          const srcx = gpu_buf[1] & 0xffff;
          const srcy = gpu_buf[1] >>> 16;
          const dstx = gpu_buf[2] & 0xffff;
          const dsty = gpu_buf[2] >>> 16;
          const xsiz = gpu_buf[3] & 0xffff;
          const ysiz = gpu_buf[3] >>> 16;

          for (y = 0; y < ysiz; y++) {
            for (x = 0; x < xsiz; x++) {
              const dstb = dstx + x < 1024 && dsty + y < 512;
              const srcb = srcx + x < 1024 && srcy + y < 512;
        ...
        case 0xc0: {
          gpu_c0_xcnt = 0;
          gpu_c0_ycnt = 0;
          let c0_xpos = gpu_buf[1] & 0xffff;
          let c0_ypos = gpu_buf[1] >>> 16;
...
function psx_gpu_update(cyc) {
  if (0) return;
  const prev_hblank = gpu_cycles >= 2560 && gpu_cycles <= 3413;

  gpu_cycles += trunc((cyc * 53693175) / 33868800);

  const curr_hblank = gpu_cycles >= 2560 && gpu_cycles <= 3413;
...
function cdrom_param_pop() {
  ...
  const data = cdrom_param_buf[cdrom_param_rd++];
...
function cdrom_resp_pop() {
  ...
  const data = cdrom_resp_buf[cdrom_resp_rd++];
...
function cdrom_data_pop() {
  ...
  const data = cdrom_data_buf[cdrom_data_rd++];
...
function cdrom_get_seek_delay(ts) {
  if (0) return;
  let delay = cdrom_pending_speed_switch_delay;
...
function cdrom_exec_cmd() {
  ...
  switch (cdrom_pending_command) {
    ...
    case 0x02: {
      const m = cdrom_param_pop();
      const s = cdrom_param_pop();
      const f = cdrom_param_pop();
    ...
    case 0x1b: {
      ...
      const ts = psx_disc_read_data(cdrom_lba);
    ...
    case 0x0e: {
      const prev_speed = cdrom_mode & 0x80;
    ...
    case 0x14: {
      ...
      const mm = trunc(f / (60 * 75));
      const ss = trunc((f % (60 * 75)) / 75);
      cdrom_push_stat3();
...
function cdrom_handle_resp1() {
  if (0) return;
  const cmd = cdrom_pending_command;
  const n = cdrom_param_wr - cdrom_param_rd;
  const expect = cdrom_cmd_nparams(cmd);
...
function cdrom_handle_read() {
  ...
  const ts = psx_disc_query(cdrom_lba);
  ...
  const size_bit = cdrom_mode & 0x20;
...
function cdrom_read_status() {
  if (0) return;
  const data_empty = cdrom_data_rd === cdrom_data_wr || !cdrom_data_req;
...
function bus_cdrom(write, offset, value, width) {
  ...
  if (write) {
    if (width === 8) {
      const reg = (cdrom_index << 2) | offset;
      switch (reg) {
        case 0:
        case 4:
        case 8:
...
function cdrom_xa_samples_per_sector() {
  if (0) return;
  const stereo = (cdrom_xa_buf[0x13] & 1) === 1;
  const f18khz = (cdrom_xa_buf[0x13] >>> 2) & 1;
...
function dma_write_dicr(value) {
  if (0) return;
  const ack = value & 0x7f000000;
  let flags = g_dma_dicr & 0x7f000000;
...
function psx_dma_do_mdec_in() {
  ...
  const size = (dmaReg[(0) * 3 + (1)] & 0xffff) * ((dmaReg[(0) * 3 + (1)] >>> 16) & 0xffff);
  const step = dmaReg[(0) * 3 + (2)] & 0x00000002 ? -4 : 4;

  for (let i = 0; i < size; i++) {
    const data = bus_access(0, dmaReg[(0) * 3 + (0)], 0, 32);
...
function psx_dma_do_mdec_out() {
  ...
  const size = (dmaReg[(1) * 3 + (1)] & 0xffff) * ((dmaReg[(1) * 3 + (1)] >>> 16) & 0xffff);

  for (let i = 0; i < size; i++) {
    const data = bus_access(0, 0x1f801820, 0, 32);
...
function psx_dma_do_spu() {
  ...
  const size = dmaReg[(4) * 3 + (1)] & 0xffff;
  const blocks = (dmaReg[(4) * 3 + (1)] >>> 16) & 0xffff;
  ...
  if (dmaReg[(4) * 3 + (2)] & 0x00000001) {
    for (let j = 0; j < blocks; j++) {
      for (let i = 0; i < size; i++) {
        const data = bus_access(0, dmaReg[(4) * 3 + (0)], 0, 32);
...
function psx_dma_do_otc() {
  ...
  let size = dmaReg[(6) * 3 + (1)] & 0xffff;
  if (!size) size = 0x10000;

  for (let i = size; i > 0; i--) {
    const addr = i !== 1 ? dmaReg[(6) * 3 + (0)] - 4 : 0xffffff;
...
function psx_dma_update(_cyc) {
  ...
  const prev_irq_signal = (g_dma_dicr & 0x80000000) !== 0;
  const irq_on_flags = (g_dma_dicr & 0x00800000) !== 0;
  const force_irq = (g_dma_dicr & 0x00008000) !== 0;
  const irq = (g_dma_dicr & 0x7f000000) !== 0;
  const irq_signal = force_irq || (irq & irq_on_flags) !== 0;
...
function bus_spu(write, offset, value, width) {
  ...
  if (width === 16) {
    if (offset === 0x1a8) {
      const addr = spu_hw_u32(0x200);
      const data = spuRam_load16(addr);
